...
-   GPU는 이 Source Color와 Source Alpha를 [[⚫ 08 - Framebuffer → Display Lifecycle/1. Framebuffer 구조|Framebuffer]]에 이미 저장되어 있는 **Destination Color**와 혼합하여 최종 픽셀 색상을 결정합니다.
